...
caption_grafo2<-
  'Nota: Datos del Barómetro de las Américas. Las encuestas fueron realizadas de enero a marzo de cada año excepto la ronda 2016, realizada de noviembre 2016 a enero 2017. El porcentaje que aprueba las protestas se calcula para quienes responden números mayores a 4 (del 1 al 10). Los porcentajes son sobre el total de personas en edad de votar.'
...
ggplot(political_graph_df,
                  ...
                  labs(x = '',
                       ...
                       caption = str_wrap(caption_grafo21,100))+
