...
date: "2023-06-17"
description: "As a (late) tribute to Epica's *The Phantom Agony* twentieth birthday, I analyse Epica's empirics by accessing the Genius, Last.fm and Spotify application porgramming interfaces (APIs) with R to analyse the Dutch band's musical features, streams and lyrics. Cover picture by [Diego Eivar](https://www.facebook.com/bubueivar)."
...
htmlwidgets::saveWidget(wc_phantom_agony, "wordcloud_phantom_agony.html", selfcontained = TRUE)
```
...
phantom_agony_wordcount %>% 
  ...
  labs(title = "Most common words in Epica's The Phantom Agony",
       x = '',
       y = '',
       caption = str_wrap("Note: Lyrics data obtained from the Genius API through the geniusr package. Tokenization of the text performed through the tidytext package.", 116),
       subtitle = str_wrap('Epica combines the theme of introspection with political and social statements', 100)) + 
  theme_daniel +
  theme(axis.text.y = element_text(colour = 'gray'),
