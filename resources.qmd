...
- [The Effect: An Introduction to Research Design and Causality](https://theeffectbook.net/), an amazing book which includes code on R, Stata and Python- the next step from URfIE. 
